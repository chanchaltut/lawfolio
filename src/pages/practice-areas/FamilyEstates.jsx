        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <div className="flex justify-center mb-6">
              <FaHeart className="text-[#c9a870] text-6xl sm:text-7xl md:text-8xl" />
            </div>
            <h1 className="text-white text-[40px] sm:text-[48px] md:text-[56px] lg:text-[64px] font-bold mb-6 leading-tight">
              Family Estates & <span className="text-[#c9a870]">Trust Planning</span>
            </h1>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="mb-16 sm:mb-20">
            ...
            <div className="bg-gradient-to-br from-[#1a1a1a] to-[#2a2a2a] rounded-[20px] p-8 sm:p-10 md:p-12 border border-[#c9a870]/20">
              <p className="text-gray-300 text-[15px] sm:text-[16px] md:text-[17px] leading-relaxed mb-6">
                We know that family dynamics can be just as complex as the law itself. Our goal is to help you organize your affairs so that your heirs are protected and your wishes are carried out exactly as intended. We focus on creating clear, uncontested plans that minimize taxes and prevent the kind of public litigation that can tear families apart.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#c9a870] to-[#b89860] rounded-[20px] p-8 sm:p-10 md:p-12 text-center">
            ...
            <p className="text-[#1a1a1a] text-lg mb-8 max-w-2xl mx-auto">
              Contact our estate planning experts to secure your family's future.
            </p>
