    ...
    <>
      ...
      <section className="relative bg-[#202020] py-16 sm:py-20 md:py-24 lg:py-28 px-4 sm:px-6 md:px-8">
        <div className="max-w-[1400px] mx-auto">
          ...
          {/* Team Cards Grid - 3 Equal Columns */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 lg:gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                {/* Image */}
                <div className="w-full h-[320px] xs:h-[360px] sm:h-[380px] md:h-[400px] lg:h-[420px] overflow-hidden image-zoom-container">
                  <img
                    src={member.image}
                    alt={member.name}
                    ...
                    <>
                      <div className="space-y-3 mb-6">
                        <a
                          ...
                          className="flex items-center justify-center gap-3 text-gray-300 hover:text-[#c9a870] smooth-hover-fast"
                        >
                        ...
                        >
                          ...
                          <span className="font-semibold text-sm break-all">{member.email}</span>
                        </a>
                      </div>
