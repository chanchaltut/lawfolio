...
const AboutSection = () => (
    <section className="w-full min-h-screen flex flex-col md:flex-row items-center justify-center bg-white relative overflow-hidden px-4 md:px-0 py-16 md:py-0">
        {/* Left: Image and shapes */}
        <div className="flex-1 flex flex-col items-center justify-center relative h-full min-w-[350px] max-w-[600px]">
            {/* Main Image */}
