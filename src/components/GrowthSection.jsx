...
const progressData = [
    { label: "Web and App Development", value: 90 },
    { label: "UI/UX Design", value: 80 },
    { label: "Digital Marketing", value: 75 },
    { label: "Search Engine Optimization", value: 70 },
];

const GrowthSection = () => (
    <section className="w-full bg-[#f4f7fb] flex flex-col md:flex-row items-center justify-center min-h-[500px] py-20 px-4">
        {/* Left Side */}
        <div className="flex-1 max-w-xl md:pl-24 mb-12 md:mb-0 text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-[#1a0a2d] mb-6 leading-tight text-left">We Work to Help<br />You Grow</h2>
            <p className="text-lg text-gray-500 text-left">We are dedicated to providing customized solutions that perfectly align with your objectives.</p>
        </div>
