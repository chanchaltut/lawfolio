...
const GrowthSection = () => (
    <section className="w-full bg-[#f4f7fb] flex flex-col md:flex-row items-center justify-center min-h-[300px] sm:min-h-[400px] md:min-h-[475px] py-8 px-4">
        ...
        <div className="flex-1 max-w-xl md:pl-24 mb-12 md:mb-0 text-left">
            <h5 className="text-[#3F51B5] text-lg font-semibold tracking-widest mb-2 uppercase text-left">Our Expertise</h5>
            ...
            {progressData.map((item, idx) => (
                <div key={item.label} className="mb-8 last:mb-0">
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-[#3F51B5] text-lg font-bold text-left">{item.value}%</span>
                    </div>
                    <div className="w-full h-4 bg-gray-200 rounded-full overflow-hidden">
                        <div
                            className="h-full bg-gradient-to-r from-[#3F51B5] to-[#5C6BC0] rounded-full transition-all duration-700"
